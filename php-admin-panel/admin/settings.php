        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="code.php" method="POST">
                    ...
                    ?>
                    <!-- baslangicda hecne set olunmadigi ucun "insert" isledir daha sonra ise hansi elave olunacaqsa onun is-sini yazdirir -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label>Address</label>
                            <textarea type="text" name="address"  class="form-control" rows="3"><?=$setting['data']['address'] ??  "" ?></textarea>
                        </div>
                    </div>
                    
                    <div class="mb-3 text-end">
                      
                        <button type="text" name="saveSetting" class="btn btn-primary">Save Setting</button>
                    </div>
